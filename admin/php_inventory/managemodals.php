    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-body bg-dark text-white">
          ...
          <p class="h3 text-center">Do you want to update product details</p>
          <p class="text-center">You wont be able to revert this</p>
          <div class="d-flex justify-content-center">
...
<div class="modal fade" id="addItems" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-scrollable .modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="staticBackdropLabel">Add Items <i id="pID"></i></h1>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        <form id="upd_items">
  ...
  <!-- Confirm Modal for Add Items -->
  <div class="modal fade" id="confirm_item" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-body bg-dark text-white">
          <span class="d-flex justify-content-center">
          ...
          <p class="h3 text-center">Do you want to add item quantity</p>
          <p class="text-center">You wont be able to revert this</p>
          <div class="d-flex justify-content-center">
            <button type="button" class="btn btn-secondary mx-2 " data-bs-dismiss="modal" id="backtoItems">No</button>
            <button type="button" class="btn btn-primary" id="updItem">Yes</button>
          </div>
        </div>
      </div>
    </div>
  ...
  <!-- Update Price-->
<div class="modal fade" id="updPrice" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-scrollable" >
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="staticBackdropLabel">Update Product# <i id="prID"></i></h1>
        <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        <form method="post" id="upd_price">
            <label for="prod_name" class="form-label">Product Name</label>
            <input type="text" name="prod_name" id="prod_name" class="form-control" required>
            <label for="updprod_price" class="form-label">Product Price</label>
            <input type="text" name="updatePrice" id="updatePrice" class="form-control" required>
            <div class="mt-3">
              <button type="reset" class="btn btn-danger">Clear</button>
              <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
              <button type="submit" class="btn btn-primary">Submit</button>
  ...
  <!-- Confirm Modal for Updating Price -->
  <div class="modal fade" id="confirm_price" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-body bg-dark text-white">
          <span class="d-flex justify-content-center">
          ...
          <p class="h3 text-center">Do you want to update the price</p>
          <p class="text-center">You wont be able to revert this</p>
          <div class="d-flex justify-content-center">
            <button type="button" class="btn btn-secondary mx-2 " data-bs-dismiss="modal" id="backtoPrice">No</button>
            <button type="button" class="btn btn-primary" id="DBPrice">Yes</button>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="modal fade" id="removeItems" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-scrollable .modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="staticBackdropLabel">Remove Items <i id="pIDs"></i></h1>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        <form id="remove_form">
          <label for="" class="form-label">Items</label>
          <select id="itemstoRemove" class="form-select">
          <option style="display:none" disabled selected value></option>
          </select>
            <label for="remove_quantity" class="form-label">Product Quantity</label>
            <input type="number" name="remove_quantity" id="remove_quantity" class="form-control" required>
            <!-- <label for="updprod_photo" class="form-label" >Product Photo</label>
            <input type="file" name="updprod_photo" id="updprod_photo" class="form-control" placeholder=".jpg, .gif and .png files only" required> -->
            <div class="mt-3">
              <button type="reset" class="btn btn-danger">Clear</button>
...
<!-- Confirm Modal for Removing Items -->
<div class="modal fade" id="confirm_remove" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-body bg-dark text-white">
          <span class="d-flex justify-content-center">
          ...
          <p class="h3 text-center">Do you want to remove items</p>
          <p class="text-center">You wont be able to revert this</p>
          <div class="d-flex justify-content-center">
            <button type="button" class="btn btn-secondary mx-2 " data-bs-dismiss="modal" id="backtoRemove">No</button>
            <button type="button" class="btn btn-primary" id="DBminus">Yes</button>
          </div>
        </div>
      </div>
    </div>
