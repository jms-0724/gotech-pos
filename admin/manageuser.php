...
<div class="wrapper">
        ...
        <div class="main">
            <nav class="navbar navbar-expand px-3 border-bottom">
                ...
                <div class="d-flex justify-content-start text-white w-100"><h4 class="text-white">User Management</h4></div>
                        ...
                        <div class="mb-3">
                            <section class="d-flex w-100">
                                <div class="flex-grow-1">
                                    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addUsers">Add New Users</button>
                                </div>
                                <div class="d-flex">
                                    <input type="text" name="search" id="searchUsers" class="rounded">
                                </div>
                            </section>  
                        </div>
    ...
    <?php
    include("php_manageusers/managemodals.php");
    include("php_manageusers/statusmodals.php");
